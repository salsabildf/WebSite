    ...
    <body >
        <div  class= "position">
            ...
            <?php
                ...
                $listeprepa = "SELECT * FROM Preparateur";
                $rep = $db->query($listeprepa);
                ...
                {                echo "<div style=\"text-align:center;\">" ;
                   while ( $repfinal = $rep->fetch_array() )
                    ...
                    echo " <a href =\"supprimerPrepa.php?name=".$repfinal['idPreparateur']."\" > -> ".$repfinal['idPreparateur'].",   ".$repfinal['nom'].",  ".$repfinal['prenom']." /a>  <br> <br>";
